...
class DetectorMessenger : public G4UImessenger
{
  ...
  private:
    ...
    std::unique_ptr<G4UIcmdWithADoubleAndUnit> fSetNuclRadiusCmd;
    std::unique_ptr<G4UIcmdWithADoubleAndUnit> fSetCytoThicknessCmd;
    std::unique_ptr<G4UIcmdWithADoubleAndUnit> fHalfWorldSizeCmd;
};
